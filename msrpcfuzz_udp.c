...
void usage()
{
	printf("Usage: ./msrpcfuzz_udp target port GUID Version VersionMinor(usually 0) function_number number_of_tries max_number_of_random_items\r\n");
	printf("Example: ./msrpcfuzz_udp 10.25.25.15 135 e1af8308-5d1f-11c9-91a4-08002b14a0fa 3 0 2 10 3 [OBJECT UUID]\n");
...
void NdrConformantStructUnmarshall()
{
...
void pretty_print(unsigned char* buffer2, unsigned int returnsize)
{
	unsigned int i;
	/*
...
#define SAVESLOTS 10
	...
	//char * activity_id="6c509fdd-8396-4b63-a812-82f52b44cd6a";
	//char * activity_id="00000000-0000-0000-0000-000000000000";
	char* activity_id = "c4658335-cb5e-4ccb-bd79-5b56c57766c1";
	  ...
	  if (buffer[2]!=DCE_BIND_ACK)
	{
	  ...
	  if (buffer[2]==0x00)
		...
		if (msrpcdo == -1 || i == msrpcdo)
		{
			...
			sent = spike_connect_udp(target, port);
			if (!s_do_dce_call(function_number, s_get_databuf(), s_get_size(), object, argv[3], atoi(argv[4]), activity_id))
			{
